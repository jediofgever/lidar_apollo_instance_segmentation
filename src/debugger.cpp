...
namespace lidar_apollo_instance_segmentation
{
  ...
  {
    using vox_nav_msgs::msg::Object;
    pcl::PointCloud<pcl::PointXYZRGB> colored_pointcloud;
    for (size_t i = 0; i < input.objects.size(); i++)
    {
      pcl::PointCloud<pcl::PointXYZI> object_pointcloud;
      pcl::fromROSMsg(input.objects.at(i).cluster, object_pointcloud);

      int red = 0, green = 0, blue = 0;
      switch (input.objects.at(i).classification_label)
      {
      case Object::CLASSIFICATION_CAR:
      {
        red = 255;
        green = 0;
        blue = 0;
      ...
      case Object::CLASSIFICATION_TRUCK:
      {
        red = 255;
        green = 127;
        blue = 0;
      ...
      case Object::CLASSIFICATION_BUS:
      {
        red = 255;
        green = 0;
        blue = 127;
      ...
      case Object::CLASSIFICATION_PEDESTRIAN:
      {
        red = 0;
        green = 255;
        blue = 0;
      ...
      case Object::CLASSIFICATION_BIKE:
      {
        red = 0;
        green = 0;
        blue = 255;
      ...
      case Object::CLASSIFICATION_MOTORCYCLE:
      {
        red = 0;
        green = 127;
        blue = 255;
      ...
      case Object::CLASSIFICATION_UNKNOWN:
      {
        red = 255;
        green = 255;
        blue = 255;
